...
Focused tests cover copyable root help, project and location precedence, parseable
JSON, complete query-plan stage evidence, unavailable-plan nulls, exact deltas, and
baseline or candidate fetch failures without tracebacks. The scaffold gate passes
